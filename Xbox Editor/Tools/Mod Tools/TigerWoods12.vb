...
Public Class TigerWoods12
    Dim tigeropener As New OpenFileDialog
    Dim filepath As String
    Private Sub Max_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Max.Click
        Points.Value = Points.MaxValue
    End Sub

    Private Sub OpenAss_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenAss.Click
        tigeropener.Title = "Open An Xbox 360 Tiger Woods PGA Tour 12 Gamesave!"
        If tigeropener.ShowDialog = Windows.Forms.DialogResult.OK Then
            Try
                filepath = tigeropener.FileName
                TitleIDVerify(filepath)
            Catch ex As Exception
                MessageBoxEx.Show("Invalid Package... This Is Not A Tiger Woods PGA Tour 12 Gamesave", Home.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                resetform()
            End Try
        End If
    End Sub
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "4541094D" Then ' Enter Ur TitleID Here ?
            Readfile()
            Points.Enabled = True
            Save.Enabled = True
            Max.Enabled = True
    ...
    Private Sub Readfile()
        ...
        reader.Position = 125044
        Points.Value = reader.ReadInt32
    End Sub
    Private Sub Writefile()
        Dim writer As New PackageIO.Writer(filepath, Endian.Big)
        writer.Position = 125044
        writer.WriteInt32(Points.Value)
    End Sub
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show(" Saved And Rehashed And Resigned", "Tiger Woods PGA Tour 12", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Tiger Woods PGA Tour 12", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
