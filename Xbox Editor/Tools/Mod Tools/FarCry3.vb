...
Public Class FarCry3
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "5553088C" Then ' Enter Ur TitleID Here ?
            readfile()
    ...
    Public Sub readfile()
        ...
        reader.Position = 18394
        MoneyII.Value = reader.ReadInt32
        reader.Close()
    End Sub
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Far Cry 3", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Public Sub writefile()
        ...
        writer.Position = 18394
        writer.WriteInt32(MoneyII.Value)
        writer.Close()
    End Sub
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Far Cry 3", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
