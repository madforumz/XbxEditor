...
Public Class brotherhood
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenAss.Click
        Open.Title = "Open An Xbox 360 Assassin's Brotherhood Gamesave"
        If Open.ShowDialog = Windows.Forms.DialogResult.OK Then
            Try
                FilePath = Open.FileName
                TitleIDVerify(FilePath)
            Catch ex As Exception
                MessageBoxEx.Show("Invalid Package... This Is Not A Assassin's Creed Brotherhood Gamesave", Home.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                resetform()
            End Try
        End If
    End Sub
    Private Sub ReadFile()
        ...
        Reader.Position = 64476
        ModChanger.Value = Reader.ReadInt16
    End Sub
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "5553085D" Then ' Enter Ur TitleID Here ?
            ReadFile()
    ...
    Public Sub WriteFile()
        ...
        Writer.Position = 64476
        Writer.WriteInt16(ModChanger.Value)
    End Sub
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Assassin's Creed Brotherhood", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Assassin's Creed Brotherhood", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
