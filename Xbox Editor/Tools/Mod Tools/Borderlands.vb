...
Public Class Borderlands
    ...
    Private Sub Borderlands_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "545407E7" Then ' Enter Ur TitleID Here ?
            ReadFile()
            Level.Enabled = True
            Xpoints.Enabled = True
    ...
    Private Sub writefile()
        ...
        'level
        writer.Position = 1015869
        writer.WriteInt32(Level.Value)
        'xp points
        writer.Position = 1015873
        writer.WriteInt32(Xpoints.Value)
        'skill
        writer.Position = 1015877
        writer.WriteInt32(Skillpoints.Value)
        'money
        writer.Position = 1015885
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Borderlands", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Borderlands", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
