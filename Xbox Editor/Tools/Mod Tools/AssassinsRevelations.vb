...
Public Class AssassinsRevelations
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Assassins Creed Revelations", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub readfile()
        ...
        reader.Position = 76144
        MoneyII.Value = reader.ReadInt32
        reader.Close()
    End Sub
    Public Sub savefile()
        Dim save As New PackageIO.Writer(filepath, Endian.Big)
        save.Position = 76144
        save.WriteInt32(MoneyII.Value)
        save.Close()
    End Sub
    Public Sub Resign()
