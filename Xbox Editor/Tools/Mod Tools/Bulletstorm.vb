...
Public Class Bulletstorm
    ...
    Private Sub OpenAss_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenAss.Click
        Open.Title = "Open An Xbox 360 Bulletstorm Gamesave!"
        If Open.ShowDialog = Windows.Forms.DialogResult.OK Then
            Try
                filepath = Open.FileName
                TitleIDVerify(filepath)
            Catch ex As Exception
                MessageBoxEx.Show("Invalid Package... This Is Not A Bulletstorm Gamesave", Home.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                resetform()
            End Try
        End If
    End Sub
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "454108EF" Then ' Enter Ur TitleID Here ?
            Readfile()
            Points.Enabled = True
            Save.Enabled = True
            Max.Enabled = True
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Bulletstorm", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Bulletstorm", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
