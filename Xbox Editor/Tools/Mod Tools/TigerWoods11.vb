...
Public Class TigerWoods11
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "454108EE" Then ' Enter Ur TitleID Here ?
            readfile()
            Max.Enabled = True
            Save.Enabled = True
            Points.Enabled = True
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Tiger Woods PGA Tour 12", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
            MessageBoxEx.Show(ex.Message, "Error!", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Tiger Woods PGA Tour 11", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
