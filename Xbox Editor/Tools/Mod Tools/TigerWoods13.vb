...
Public Class TigerWoods13
    ...
    Private Sub OpenAss_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenAss.Click
        tigeropener.Title = "Open An Xbox 360 Tiger Woods PGA Tour 13 Gamesave!"
        If tigeropener.ShowDialog = Windows.Forms.DialogResult.OK Then
            Try
                filepath = tigeropener.FileName
                Readfile()
            Catch ex As Exception
                MessageBoxEx.Show("Invalid Package... This Is Not A Tiger Woods PGA 13 Gamesave", Home.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
                resetform()
            End Try
        End If
    End Sub
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "45410972" Then ' Enter Ur TitleID Here ?
            Readfile()
            Points.Enabled = True
            Save.Enabled = True
            Max.Enabled = True
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show(" Saved And Rehashed And Resigned", "Tiger Woods PGA Tour 13", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Tiger Woods PGA Tour 13", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
