...
Public Class AssassinsCreed3
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "555308AE" Then ' Enter Ur TitleID Here ?
            readfile()
    ...
    Public Sub readfile()
        ...
        reader.Position = 53272
        ModChanger.Text = reader.ReadUInt32
        reader.Close()
    End Sub

    Private Sub Max_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Max.Click

        If MessageBoxEx.Show("Warning this may corrupt your file ! Do This At Your Own Risk !", "Assassin's Creed III", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
            ModChanger.Text = ModChanger.MaxValue
        End If
    End Sub
    Public Sub savefile()
        Dim save As New PackageIO.Writer(filepath, Endian.Little)
        save.Position = 53272
        save.WriteInt32(ModChanger.Value)
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            MessageBoxEx.Show("Saved And Rehash And Resigned", "Assassin's Creed III", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBoxEx.EnableGlass = False
    ...
    Public Sub Resign()
        ...
        Try
            ...
            ms.Close()
        Catch ex As Exception
            MessageBoxEx.Show(ex.Message, "Assassin's Creed III", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End Try
