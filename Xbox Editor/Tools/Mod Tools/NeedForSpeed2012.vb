...
Public Class NeedForSpeed2012
    ...
    Public Function TitleIDVerify(ByVal filepath As String)
        ...
        BR.Close()
        If TitleID = "45410961" Then ' Enter Ur TitleID Here ?
            readfile()
            SpII.Enabled = True
            ResultsII.Enabled = True
            Save.Enabled = True
    ...
    Public Sub readfile()
        ...
        ' read points
        reader.Position = 100376
        SpII.Value = reader.ReadInt32
        ' read driving
        reader.Position = 108340
        DrivingII.Value = reader.ReadInt32
        ' read resulits
        reader.Position = 108328
        ResultsII.Value = reader.ReadUInt32
    End Sub

    Private Sub MaxBB_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MaxBB.Click
        SpII.Value = SpII.MaxValue
        DrivingII.Value = DrivingII.MaxValue
        ResultsII.Value = ResultsII.MaxValue
    End Sub
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        Try
            ...
            writer.Position = 108340
            writer.WriteInt32(DrivingII.Value)
            writer.Position = 108328
            writer.WriteInt32(ResultsII.Value)
        Catch ex As Exception
            MessageBoxEx.Show("Can't Save Your NFS Most Wanted Gamesave", "Need For Speed Most Wanted", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    Public Sub Resign()
